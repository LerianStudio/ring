...
description: |
  ...
  interactive HTML page (via ring:visualize) and optionally generates
...
trigger: |
  ...
  - User asks to run migrate-v4 analysis
...
related:
  complementary: [ring:dev-cycle, ring:dev-refactor, ring:codebase-explorer, ring:visualize, ring:backend-engineer-golang]
...
Use `ring:visualize` to create an interactive HTML page. Pass this prompt:
...
> Generated by ring:migrate-v4 on {date}
