...
trigger: |
  ...
  - Building infrastructure/CI-CD → ring-dev-team:devops-engineer
  - Frontend with design focus → ring-dev-team:frontend-designer
  - Test strategy needed → ring-dev-team:qa-analyst
  - Reliability/monitoring → ring-dev-team:sre
