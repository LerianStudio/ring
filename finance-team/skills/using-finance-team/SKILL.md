...
trigger: |
  ...
  - Building budgets or forecasts → ring-finance-team:budget-planner
  - Financial modeling (DCF, projections) → ring-finance-team:financial-modeler
  - Cash flow or treasury management → ring-finance-team:treasury-specialist
  - Accounting operations or close → ring-finance-team:accounting-specialist
  - KPI dashboards or metrics → ring-finance-team:metrics-analyst
